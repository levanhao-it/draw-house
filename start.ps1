...
$files = @(
    ...
    "src/lib/id.ts",
    "src/lib/storage.ts",
    "src/render-core/animation.test.ts",
    "src/render-core/animation.ts",
    ...
    "src/render-core/layers/compassLayer.ts",
    ...
    "src/render-core/shapes/textTag.ts",
    "src/render-core/shapes/unitCard.ts",
    "src/render-core/shapes/zonePolygon.ts",
    "src/render-core/text/formatPrice.test.ts",
    "src/render-core/text/formatPrice.ts",
    "src/render-core/text/truncate.test.ts",
    ...
    "src/types/markerPoints.test.ts",
    "src/types/markerPoints.ts"
)
